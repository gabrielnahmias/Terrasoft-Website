...
/* TODO:	Change to be more like:
 *			https://github.com/salathe/jquery.query-yql
 *			https://github.com/hail2u/jquery.query-yql
 *			
 *			Create global data variable that passes all important data to URL.
 *			
 *			Rename OAuthURL function (adding _ to all other private functions) and make it
 *			one that simply returns an array of OAuth information to pass depending on if
 *			a key and secret have been provided.
 *			
 *			Add protocol detection to appropriate areas.
 *			
 */
...
( function ($) {
	...
	var sErrorPrefix = "yqlQuery ($.yql): ";
	
	var methods = {
		
		getHTML: function(oOptions) {
			
			// Simple extension method to return HTML content.
		...
		yqlURL: function (oOptions) {
			...
			// Generate URL for querying the YQL API.
