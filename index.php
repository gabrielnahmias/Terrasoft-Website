...
<body>
        ...
        <div id="content">
            ...
            <div id="symbol">
                ...
                <div id="contact" class="box">
                    ...
                    <p>You may contact us through any of the following methods.</p>
                    
                    <label for="email">Email Us:</label>
                    
                    <a href="mailto:admin@terrasoftlabs.com"><em>admin at terrasoftlabs.com</em></a>
                    
                    <br/>
                    <br/><label for="email">Call Us:</label> <a href="tel:12132593589"><em>(213) 259-3589</em></a>
                ...
                -->
                    ...
                    <div class="radial_div" style="position: relative">
                            ...
                            <div class="radial_div_item" style="position: absolute; left: 155px; top: 370px;"><a href="prj/"><img src="img/menu/prj.png" title="Our Project Directory!" width="48" /></a></div>
                            <div class="radial_div_item" style="position: absolute; left: -15px; top: 280px;"><a href="#contact" target="_self"><img id="contactOpener" src="img/menu/message.png" title="Contact Us!" width="48" /></a></div>
            ...
            <div id="info">
                ...
                <div class="company"><img src="img/logo.png" title="Terrasoft: Connect the World" /></div>
	...
	<noscript>
		...
		<div id="contact" class="box shown">
